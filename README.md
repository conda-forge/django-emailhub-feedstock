About django-emailhub-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-emailhub-feedstock/blob/main/LICENSE.txt)
...
Development: https://gitlab.com/h3/django-emailhub

Documentation: http://django-emailhub.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2891&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-emailhub-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-emailhub` can be installed with `conda`:
...
```
mamba install django-emailhub
```

It is possible to list all of the versions of `django-emailhub` available on your platform with `conda`:
...
```
mamba search django-emailhub --channel conda-forge
```
...
mamba repoquery search django-emailhub --channel conda-forge

# List packages depending on `django-emailhub`:
mamba repoquery whoneeds django-emailhub --channel conda-forge

# List dependencies of `django-emailhub`:
mamba repoquery depends django-emailhub --channel conda-forge
```
